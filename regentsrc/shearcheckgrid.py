...
for i in range(401):
	...
	rho4 = Loadrho(rhofiles423, i, size, num, type)
	...
	V4 = Loadrho(vxfiles423, i, size, num, type)/rho4
	...
	Y4 = Loadrho(vyfiles423, i, size, num, type)/rho4
	...
	E4 = Loadrho(Efiles423, i, size, num, type)
	E6 = Loadrho(Efiles623, i, size, num, type)
	N = len(rho0)
	...
	plt.plot(x, E6, CBC[1], lw=1, alpha=0.8, label=r'$10^{-6}$')
	plt.plot(x, E4, CBC[0], lw=1, alpha=0.8, label=r'$10^{-4}$')
	plt.plot(x, E3, CBC[2], lw=1, alpha=0.8, label=r'$10^{-3}$')
	plt.plot(x, E2, CBC[3], lw=1, alpha=0.8, label=r'$10^{-2}$')
	plt.plot(x, E0, CBC[4], lw=1, alpha=0.8, label=r'$10^0$')
	plt.ylim(1.78,1.92)
	#plt.ylim(2.48,2.65)
	plt.legend(title=r'$\mu_r$')
	plt.grid(alpha=0.3)
	...
	plt.plot(x, Y6, CBC[1], lw=1, alpha=0.8, label=r'$10^{-6}$')
	plt.plot(x, Y4, CBC[0], lw=1, alpha=0.8, label=r'$10^{-4}$')
	plt.plot(x, Y3, CBC[2], lw=1, alpha=0.8, label=r'$10^{-3}$')
	plt.plot(x, Y2, CBC[3], lw=1, alpha=0.8, label=r'$10^{-2}$')
	plt.plot(x, Y0, CBC[4], lw=1, alpha=0.8, label=r'$10^0$')
	plt.legend(title=r'$\mu_r$')
